...
// GreatDBPaxoses returns a GreatDBPaxosInformer.
func (v *version) GreatDBPaxoses() GreatDBPaxosInformer {
	return &greatDBPaxosInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
