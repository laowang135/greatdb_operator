...
func NewReadAndWriteController(
	...
	controller := &ReadAndWriteController{
		...
		Queue: workqueue.NewNamedRateLimitingQueue( // Mixed speed limit treatment
			...
			"read_and_write_service",
		),
		managers: manager,
		queueMgr: queueMgr.NewResourcesManager(10, 10),
	}
...
func (ctrl *ReadAndWriteController) syncReadAndWrite(cluster *v1alpha1.GreatDBPaxos) (err error) {
